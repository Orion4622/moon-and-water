...
avant la formation de la Lune. Une planète $B$, en passage rasant et non collisionnel, n'apporte pas
l'essentiel de la matière lunaire : elle agit comme un \emph{agent
...
planète $B$ n'apporte pas l'essentiel de la matière
...
\end{falsif}
\begin{apport}
Met en avant ce que le chemin proposé apporte de propre.
\end{apport}
...
Dans ce cadre, un corps planétaire $B$ n'apporte pas l'essentiel de la matière lunaire. Son passage demeure non collisionnel et agit comme un agent
...
proto-terrestre}. Elle n'apporte pas l'essentiel de la matière lunaire. Son
...
Le \emph{passage rasant non collisionnel d'une planète $B$} est l'élément propre à la théorie. Le
disque existe avant la rencontre ; $B$ n'a donc pas à le créer, et son action se limite à agir sur
lui par son champ gravitationnel. Cette économie de moyens est le trait distinctif du chemin
proposé : la matière est déjà là, le moment cinétique est déjà là, et l'agent extérieur ne fait
que redistribuer l'un et l'autre.
...
indiscernable de celle du manteau terrestre, un moment cinétique élevé. Ces propriétés ne se
déduisent pas d'une loi générale ; elles demandent des \emph{circonstances précises}. Le travail
proposé consiste donc moins à raconter ce qui s'est passé qu'à délimiter, dans l'espace des
paramètres, la région où ces circonstances sont simultanément réalisables. Cette région est le
\emph{domaine viable} $\mathcal{D}_{\mathrm{viable}}$ défini au chapitre~\ref{ch:portes}. Si elle
est non vide, le chemin proposé est physiquement praticable ; si elle est vide, il ne l'est pas.
C'est en ce sens que la théorie est une théorie de chemin, et c'est aussi en ce sens qu'elle est
falsifiable.
\end{ideephys}
...
Phase dominante & gaz et solides & solides seuls \\[3pt]
Support de pression & oui, assuré par le gaz & non \\[3pt]
...
$M_{D,0}=6{,}9\,M_L$ réparti selon $\Sigma\propto r^{-1}$ entre $1{,}6$ et $2{,}9\,\Rt$, la densité
surfacique vaut $\Sigma\simeq9{,}5\times10^{8}$~kg\,m$^{-2}$ au bord interne et
$5{,}3\times10^{8}$~kg\,m$^{-2}$ au bord externe, et la stabilité $Q_T^{\mathrm{part}}\ge1$ demande
\begin{equation}
...
Pour un réservoir de $6{,}9\,M_L$ réparti selon $\Sigma\propto r^{-1}$ entre $1{,}6$ et
$2{,}9\,\Rt$ en rotation képlérienne, on obtient
$L_{D,0}\simeq3{,}8\times10^{34}$~kg\,m$^2$\,s$^{-1}$, donc $\ell_D\simeq0{,}88$ et
\begin{equation}
...
\label{eq:Dfen}\\
\mathcal{D}_{\mathrm{imp}}&=\left\{\Theta_I:\ \text{l'écart entre la forme close~\eqref{eq:impulsion-close}
et l'intégration directe sur la conique hyperbolique reste inférieur à un seuil fixé}\right\},
\label{eq:Dimp}\\
...
La deuxième porte sur l'intégrité de $B$. La condition de non-contact,
$q_B>\Req+R_{B,\mathrm{eff}}\simeq1{,}7\,\Rt$ pour $M_B=0{,}1\,\Mt$, est bien moins contraignante
que la dislocation de marée, $d_{R,B}\simeq2{,}75\,\Rt$ d'après l'équation~\eqref{eq:RocheB}. Elles
méritent donc de rester séparées, et le facteur $\chi_{\mathrm{tide}}>1$ fixe la marge de sécurité :
$\chi_{\mathrm{tide}}=1{,}1$ donne $q_B>3{,}03\,\Rt$ et $\chi_{\mathrm{tide}}=1{,}2$ donne
$q_B>3{,}30\,\Rt$. La borne basse du tableau~\ref{tab:grille} doit être choisie en cohérence avec
$\chi_{\mathrm{tide}}$ ; les colonnes les plus rasantes de la carte pilote sont alors écartées, ce
qui est le comportement attendu d'une marge de prudence.
...
Un réservoir de $6{,}9\,M_L$ ainsi structuré porte, en rotation képlérienne,
\begin{equation}
...
mécanisme d'évacuation explicite en Phase~C, par exemple une capture en résonance d'évection
solaire ou une transition de plan de Laplace \cite{MurrayDermott1999,TremaineTouma2009}, l'un et
l'autre relevant de la mécanique céleste classique du système Terre--satellite. C'est
...
$M_{D,0}=6{,}9\,M_L$, soit $0{,}085\,\Mt$, le réservoir atteint $0{,}85\,M_B$ et son autogravité
devient du même ordre que le forçage mesuré ; l'approximation des particules test est en revanche
légitime dans la branche légère, $M_{D,0}\simeq2$--$3\,M_L$, vers laquelle pointent le
contrôle~\eqref{eq:controle-Ida} et le critère~\eqref{eq:sigmar-reservoir}. Le
tableau~\ref{tab:pilote-etaL} se lit donc comme une carte de tendance en $(q_B,i_B)$, à masse
fixée. Ensuite son domaine de validité en mécanisme : les $1152$ particules représentent le seul
...
locale : $\eta(r)=\Omega_K(r)\,t_{\mathrm{enc}}\ll1$.
